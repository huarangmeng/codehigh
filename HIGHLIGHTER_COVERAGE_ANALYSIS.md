...
| # | 类别 | 已支持 | 缺失 | 覆盖率 |
|---|------|--------|------|--------|
| 1 | Token 类型体系（`ast/`） | 0/18 | 18 | 0% |
| 2 | 主题系统（`theme/`） | 0/12 | 12 | 0% |
| 3 | 词法分析器基础设施（`lexer/`） | 0/9 | 9 | 0% |
| 4 | 语言支持 — 系统语言 | 0/3 | 3 | 0% |
| 5 | 语言支持 — 脚本语言 | 0/3 | 3 | 0% |
| 6 | 语言支持 — 系统/底层语言 | 0/3 | 3 | 0% |
| 7 | 语言支持 — 数据/配置语言 | 0/3 | 3 | 0% |
| 8 | 语言支持 — 标记/样式语言 | 0/4 | 4 | 0% |
| 9 | Markdown 代码围栏解析器（`parser/`） | 0/11 | 11 | 0% |
| 10 | Compose 渲染组件（`renderer/`） | 0/12 | 12 | 0% |
| 11 | 流式增量渲染引擎（`stream/`） | 0/9 | 9 | 0% |
| 12 | 可见性原则（最小对外暴露） | 0/23 | 23 | 0% |
| 13 | 预览演示模块（`code-high-preview`） | 0/16 | 16 | 0% |
| 14 | 多平台支持（KMP） | 0/5 | 5 | 0% |
| 15 | 性能与工程质量 | 0/9 | 9 | 0% |
| | **总计** | **0/139** | **139** | **0%** |
